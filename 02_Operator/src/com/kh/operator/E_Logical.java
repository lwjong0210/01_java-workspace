...
public class E_Logical {
	...
	/*
	 * 논리연산자(이항연산자)
	 * 두 개의 논리값(true, false)을 연산해준느 연산자
	 * 논리연산한 결과마저도 논리값임 !!
	 * 
...
//		System.out.println("사용자가 입력한 값이 대문자 입니까? : " + result);
	...
	public void method3() {
		 ...
		 * false && false	=> false
		 * 
		 * ** && 연선저룰 기준으로 앞의 결과가 false일 경우 뒤의 조건은 굳이 실행하지 않는다!! **
		 * 
		...
		public void method5() {
			int num = 10;
//			boolean result1 = (num < 5) && (++num > 0);	// num = 10
			boolean result1 = (num > 5) && (++num > 0);	// num = 11
...
//			boolean result2 = (num2 > 20) || (++num2 > 0);	// num2 = 11
			boolean result2 = true || (++num2 > 0);	// Dead Code : 절대로 실행될일 없는 코드
